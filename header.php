...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
  ...
  <head>
    ...
    <!-- html5.js -->
    <!--[if lt IE 9]>
      <script src="/wp-content/themes/wordpress-bootstrap-master-child/library/js/html5shiv.js"></script>
    <![endif]-->
    ...
    <!--[if lt IE 9]>
      <script src="/wp-content/themes/wordpress-bootstrap-master-child/library/js/respond.min.js"></script>      
    <![endif]-->
  </head>
